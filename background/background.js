...
function stopScreenRecording() {
    ...
    recorder.stop(function onStopRecording(blob, ignoreGetSeekableBlob) {
        ...
        rand_str = (Math.floor(Math.random() * (1000000 - 1000)) + 1000).toString();
        date = new Date();
        cur_date_str = date.getDate().toString()+"-"+date.getMonth().toString()+"-"+date.getFullYear().toString()+"_"+date.getHours().toString() +"-"+ date.getMinutes().toString()+"-"+date.getSeconds().toString() +"_"+rand_str;
